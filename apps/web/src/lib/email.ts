...
export async function sendLicenseEmail(params: LicenseEmailParams): Promise<void> {
  ...
  const text = [
    ...
    ``,
    `Keep this email for your records. Questions: support@tacholens.com`,
  ].join("\n");
  const html = `
    <div style="font-family: -apple-system, system-ui, sans-serif; max-width: 560px; margin: 0 auto;">
      ...
      <p style="color: #666; font-size: 14px;">Keep this email for your records. Questions: <a href="mailto:support@tacholens.com">support@tacholens.com</a></p>
    </div>
  `;
