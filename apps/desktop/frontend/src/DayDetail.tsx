...
import { Card, CardContent, CardHeader, CardTitle } from "@tacholens/ui/components/card";
import {
  Collapsible,
  CollapsibleContent,
  CollapsibleTrigger,
} from "@tacholens/ui/components/collapsible";
import { ScrollArea } from "@tacholens/ui/components/scroll-area";
import {
  Table,
  TableBody,
  TableCell,
