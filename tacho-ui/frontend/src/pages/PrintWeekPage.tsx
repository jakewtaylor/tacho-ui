      ...
      <article className="print-sheet">
        <header className="print-header">
          <div className="print-title">
            ...
            <div className="print-subtitle">{formatWeekRange(week.weekStart, week.weekEnd)}</div>
          </div>
        ...
        <section className="print-summary">
          ...
          <div className="print-row">
            ...
            <span>
              {week.rollup.daysWithDriving} / 7 · Days over 9h: {week.rollup.daysOverLimit}
            </span>
          </div>
        </section>
        ...
        <section className="print-infringements">
          ...
          {infringements.length === 0 ? (
            <p className="print-compliant">✓ No infringements detected for this week.</p>
          ) : (
            <ol>
              {infringements.map((it, i) => (
                <li key={i} className={`print-inf print-inf-${it.severity}`}>
                  ...
                  {it.ruleRef && <div className="print-inf-ref">{it.ruleRef}</div>}
                </li>
              ))}
            </ol>
          )}
...
function DayRow({
  ...
  const vehicle = shift ? vehicleForShift(vehicles, shift.startTime, shift.endTime) : null;
